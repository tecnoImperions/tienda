...
$mods=[
    ...
    ['Productos','productos/productos.php','box','primary'],
    ['Categorías','productos/categorias.php','tags','success'],
    ['Usuarios','usuarios/usuarios.php','people','info']
];
foreach($mods as [$t,$l,$i,$c]): ?>
<div class="col-md-3">
<div class="card card-hover text-center">
<div class="card-body">
<i class="bi bi-<?= $i ?> text-<?= $c ?> fs-1"></i>
<h5 class="mt-2"><?= $t ?></h5>
<a href="<?= $l ?>" class="btn btn-<?= $c ?> btn-sm mt-2">Acceder</a>
</div>
</div>
</div>
<?php endforeach; ?>
