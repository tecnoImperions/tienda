...
<div class="card-body">
<table id="tablaUsuarios" class="table table-striped table-hover nowrap" style="width:100%">
<thead>
<tr>
<th>ID</th>
<th>Usuario</th>
...
$(document).on('click', '.btn-toggle', function(){
    ...
    Swal.fire({
        ...
        text: activo ? 'El usuario no podrá acceder al sistema' : 'El usuario podrá acceder nuevamente',
        icon: 'question',
        showCancelButton: true,
